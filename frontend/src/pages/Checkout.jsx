...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    try {
      ...
      if (!orderRes.ok || !orderData.key || !orderData.orderId) {
        ...
        handler: async function (response) {
          ...
          if (verifyRes.ok) {
            ...
            if (saveOrderRes.ok) {
              ...
              alert(orderData.message || 'Order saving failed');
              console.error('Order save error:', orderData);
            }
          } else {
  ...
  const bypassPayment = async () => {
    try {
      ...
      if (saveOrderRes.ok) {
        ...
        alert(saveData.message || 'Failed to create order');
      }
    } catch (error) {
